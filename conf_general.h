 ...
 * Servo output driver
 */
#define SERVO_OUT_PULSE_MIN_US		100	// Minimum pulse length in microseconds
#define SERVO_OUT_PULSE_MAX_US		250	// Maximum pulse length in microseconds
#define SERVO_OUT_RATE_HZ			10000		// Update rate in Hz
